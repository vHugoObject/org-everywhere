...
import { getYearMonthDayAndDayNameFromTimestampObject } from "../lib/timestamps";
...
export const assertYearMonthDayAndDayOfWeekTimestampObject = pipe([
  getYearMonthDayAndDayNameFromTimestampObject,
  assertNumbers,
]);

export const assertYearMonthDayAndDayOfWeekofArrayOfTimestampObjects = map(
