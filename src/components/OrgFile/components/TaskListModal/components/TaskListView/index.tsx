...
function TaskListView(props) {
  ...
  // every render.
  function getPlanningItemsAndHeaders({
    headersForFiles,
    todoKeywordSetsForFiles,
  }) {
    ...
    const isTodoKeywordInDoneState = todoKeywordSetsForFiles.map(
      (todoKeywordSets) => createIsTodoKeywordInDoneState(todoKeywordSets),
    );
...
const mapStateToProps = (state) => {
  ...
  return {
    ...
    headersForFiles:
      state.org.present.getIn(["search", "filteredHeaders"]) || Map(),
